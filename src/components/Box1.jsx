  ...
  return (
    <div className="B1">
      <div className="subB1">
        ...
        <div className="gets">
          {/* <img src="gets1.svg" alt="" className="gets1" />
          <img src="gets2.svg" alt="" className="gets2" /> */}
          <p className="gets1">GET STARTED</p>
          <p className="gets2">GET STARTED</p>
        </div>
      </div>
      <div>
        <img src="Component 1.svg" alt="" className="component1" />
      </div>
    </div>
  );
};
